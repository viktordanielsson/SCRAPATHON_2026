/**
 * SENTINEL — event contract (single source of truth).
 *
 * The in-browser engine and the server functions both import this:
 *   import { Envelope, ServerEvent, Tactic } from '@/sentinel/protocol'
 *
